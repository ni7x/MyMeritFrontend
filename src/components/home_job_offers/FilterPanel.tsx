...
const FilterPanel: React.FC<{
  ...
  return (
    <div className="h-full">
      ...
      >
        <div className="lg:mt-0 h-[100%] flex flex-col">
          <div className={"flex justify-between border-b-[1px] mb-5 border-main-border "  +(isPopupOpen ? "" : "hidden")}>
            <p className="font-medium text-sm text-task-lighter">FILTERS
            </p>
            <button
                onClick={togglePopup}
                className={
          ...
          <div className="flex flex-col h-full w-full gap-3">
            ...
            <div className="flex flex-col pt-2 pb-2  lg:items-stretch">
              <label className="pb-1.5 lg:pb-2 text-sm font-medium">Opens To</label>
              <input
                  type="date"
                  className="outline-none mt-1 p-2 px-3 w-[100%] rounded bg-main-lighter-2"
          ...
          <button
              className={"w-[100%] m-auto bg-emerald-400 text-sm mt-5 font-semibold rounded p-3 " + (isPopupOpen ? "" : "hidden")}
              onClick={togglePopup}
          >
            FILTER
          </button>
