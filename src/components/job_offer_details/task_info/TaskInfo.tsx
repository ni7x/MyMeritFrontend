...
import {
    faChevronRight,
    faClock,
    faDownLeftAndUpRightToCenter, faUpRightAndDownLeftFromCenter
    ...
    if(isHidden){
        return (
            <div className="flex flex-col rounded flex-1 h-full overflow-x-auto max-w-[35px]">
                ...
                >
                    <FontAwesomeIcon icon={faUpRightAndDownLeftFromCenter} className="text-main-lighter"/>
                </button>
            </div>
        )
    }
            ...
            <div className="flex flex-col bg-terminal-color rounded w-[100%] h-full overflow-x-auto">
                <div className="p-[1.5rem]">
                    ...
                    <div className="flex mt-5 justify-between">
                        <a className="flex bg-emerald-500 gap-2 p-2 px-3 text-center text-sm rounded-b rounded text-xs  font-semibold text-white" href={`/job/${jobId}`}>
