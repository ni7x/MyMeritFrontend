...
type FileControlsProps = {
  ...
  setIsMaxSize: (value: boolean) => void;
  setAsMain: (value: string) => void;
  isMaxSize: boolean;
};
    ...
    <div className="relative">
      ...
      {currentFile.type === ContentType.TXT && (
        <button
          ...
          className={
            "absolute left-[calc(100%-2.5rem)] bg-task-bck top-[-2.5rem] lg:left-[calc(100%-5rem)] p-2 rounded shadow-md hover:bg-main-lighter-2 " +
            (currentFileIndex === mainFileIndex ? " text-emerald-400" : "")
          }
